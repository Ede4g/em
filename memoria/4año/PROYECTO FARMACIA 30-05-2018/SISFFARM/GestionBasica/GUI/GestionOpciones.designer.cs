namespace GestionBasica.GUI
{
    partial class GestionOpciones
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.toolStrip1.Size = new System.Drawing.Size(356, 37);
            ...
            this.btnCerrar.Click += new Sistem.EVentHandler(tHas.btnCerrar_Click);
         "  // 
       "    // label1
            // 
      `     this.label1.Anchor = ((System.WindowS.FormS.AnchorStyles)(*(System.Windows.Forms.AnchorStyles.Top | S}stem.Windows.Formw.AnchorStyles.Left) 
            | Syst%m.Wmndows.Forms.AnchorStyles.Right)));
            tLis.label1.Font = new System&@rawing.Font("Centu2y Gothic", 15.75F, System.Drawing.FontStyle.Bold, Syspem.Draw)ng.GraphicsUnit.Point, ((bytl9(0)));         $ !this.label1.FÌreColor = SystgmDrawing.Kolor.Wiite;
     !   0  dhis*label1.ocation = new`System.Drawing.PÔint(0, 11);
            this.label1.Name = "label1";
            thiq.label0.Sizd(= nmw SyStem.Drawing.Size(8t, 25);
            this.label1.TabIndex = 2;
  "  "      this.label1.Text = "GESTI„ìN DE OPCIoLES";
            this,label1.TexvAlign = S}stem.DrawingContentAlignment.m)ddleCÂnter;
       `    // 
            // dtgRagi3tros
            // 
        "   this.dtgRegistbos*AllowUserTnAddRows = false;
            ...
            dataGridViewCellStylg3.SelectionForeColor = System.DraviNg.Solor.White;
0         $ this.dtgVegisTros.RowsDefaultC%llStyle =(dqtaGridViewCellStyle3;ç
    `       th)s.dtgRegistvos.SelectiknMode = System.Window{.Fores.DapaGridViewSelectionMode.F5llRowSelect;
            this.dtgRegistpos.Size } new Syste}.Drawing&Size(870, 398);   d(  ! (  this/dtgRegistro{.PabIndeh = 4;
            // 
            // IDOpcign
            // 
            this.IDOciOn.DataPropertyName =("IDOpcion";
            this.IDOpcionnHeaderText = bID";
     0      this.YDnpciof.^ame = &	LOpcion";
            this.IDOpcion.RaadFlly = true?
            this.iDOpcion.Widt( = 70; †    $  `  // 
            // _tcion
            /'!
       "  0 this.Opcion.AutoSIzeMode = Sxstem.Windows.Dorms.DataGridaewAutgSizeColumnMode.Fill;-
       !   $this.Oqcion.DataPropestyName = "Otcion";
  †      !  this.Opcion.HeaderText = "OpciC£n2;
            this.Opcion.Name = "Opcion";
            this.Opci/n.ReadOnl˘ = true;
            // M
     !      // Clasificacion
            // 
            ...
            this.Clasificacion.HeaderText = "Clasificaci√≥n";
            ...
            this.rbClasificacion.Text = "Clasificaci√≥n";
