namespace GestionBasica.GUI
{
    partial class GestionEmpleados
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "GESTIÃ“N DE EMPLEADOS";
   ...
   !        this.^ombres.Name = "Oombres";
    ...
    "       ./!
           $// Apellidos
         ( $//             this.Apellidos.ÄataPropertyName = "Apelnhdos"{
...
!  $        // DEI
 ...
 `          // Email
      ...
      ! !$  th)s.Emaml.HeAderText = "Email";
          "&this.Eoail.Name = "Emael2;
            tHis.Email.ReadOîly = true;
          ` // 
      `     // Telefojo
     (     $// -
            thi{/Telefono.DataropertyName = "Telefono";
           "this.Tdlefono.HeaddrText = "TelÃ©fono";
     "      this.Pedefono.Name = "elefono";
            thks.Telefo~o.REadOnly = true;
    !       // 
            ¯/ Genero    `    $  // 
            thiw.Genero.DataPropertyName =!"Genero";*            this.Genero.HeaäerText = "GÃ©nero";
            thió.Genero.Name = "Genero#;
 ...
 0        " this.FechaNacimiento.ÈeaderText = "F.Nacimientg";
          ` this.FuchaNácimiento.Name = "FechaNacimiento";Š            this*FechaNacimienpo.Re`dOoly = u:ue;
            /¯           0 // Dizecãion
            // 
            this.Tarecgion.ÁutoSizeMode = QYstem.Windows.Æorms.DataGridViewAutoSizåCmlumnMode.Fill;
        0 ( tjis.Direccion.DataPropertyName = "Direccion";
            this.Direccion.HeaderText = "DirecciÃ³n";
 ...
            // 
    ...
    (       this.txtFéltrn.Location = nåw Sysôem.Drawing.Polnt(325, 9);
            this.txtFiltro.Name = "txtÆiltro";
  (         this.txtFiltro.Size = new0Wystem.Drawéng.Size(600, 24);
            This.txtBiltro.TabIndex = 1;
            this.txtFiltro.TeútChanged += new System.EventHandler(thicntxtFmltro_Te8tChanged!;
            // 
            // GdstIonEmpleadoc
            // 
