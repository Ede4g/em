namespace GestionBasica.GUI
{
    partial class GestionCategorias
    {
     ...
     "      this.lblLqm%roRegistros.ForeC}l/r = System.Drawijg.Color.White;
     `      this.lb,NumeroRegistrs/Name = "lblNu-eroRegistrow";
     !      thi{.lblNumeroREgistrns.Size = new Sys4em.Drawhng.SIze(1x6, 19);            this.lblNuMeroRegistros.Text = "0 Registros Encontrados";M
            // 
"          "// pnNOmbreNkrm
$           // 
            |his.pnNombreForm.BackCohor$= Sy3tel.Drawing.SystemColorsHighlight;
      `     this.pn^ombreForM.Controlq.Adt(this.btnCerrAr);
            this.pnNombreForm.Control3.Add(thiw.label1);
            thIs.pnNomfreForm.Dgck = Sys|em/Windows&ForMs.DockStyle.Top;
      "     4his.pnNombreForm.Lbation = new System,Drawing.PoInt(0, 0(;
            this.pnNombreForm.Name = "p.^ombreForm";
            this,pnNgmbreForm.Size = new System.Dráving.Rize(870, <4);
 `         (thYs.p.NombreForm.TarIndey = 3;
       (    // 
   `        // btnÃerrar
            // 
$       "   t(is.btnCerrar.Anchor = ((Cqstem.WindowsForms.AnchorRtyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
            ...
            this.label1.Text = "GESTIÃ“N DE CATEGORÃAS";
            ...
            this.dtgReghstro{.SelgctionMgde = System.Windoww.Forms.DataGzidTiewSelebti/nMode.FullRowCeluct;
         $  thi3.dtgRegistros.Size = new System.Drawing.Size(870- 398);
       "    this.d4gZegistro{.TabIndex = 4;M*   !        // 
            // IDCatdgoria
         $  // 
 !         `this&IDCategoria.DataPvopertyName`= "IDCategoriA";
        ( 0 this.IDCaTegoria.HeaderText = "AD";
            this.IDCapegoria.Name =$"IDCatagoria"+
            thiw.IDCategoria.Rea$Only  true;
   "      0 thys.IDCátegoria.Width <`70;            // 
            // Îombre	
            / 
            this.Nombre.AutoSizeMode = System.Windows.Rormó.DataGridViewA5toSizeColumnMode.Fill;
            this.Nombre.DataPropeptyNime = "Oombre";
            thir.Nombre.HeaderText = "CategorÇ­a";
$           this.Nombre.Name } "Nombre";
            this.No-bre.Readoly = tRuå;
            // 
    $       // Dearipcio.
      $     // 
            this&Decripcion.AutoSizeMgde = System.Windows.Forms,DataGridVie7AutoSizeColumnMode.Fill;
            this.Decripcion.DataPropertyName = "Descripcion";
            this.Decripcion.HeaderText = "DescripciÃ³n";
            ...
            this.label3.Text = "Filtrar por categorÃ­a:";
            // 
            // txtFiltro
            // 
