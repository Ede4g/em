...
namespace CacheController
{
    public class Cache
    {
        ...
        public static DataTable TODOS_LOS_PRODUCTOS()
        {
            DataTable Resultado = new DataTable();
            StringBuilder Consulta = new StringBuilder();
            Consulta.Append("SELECT a.IDProducto, a.Nombre, a.Alias, a.Codigo, a.Descripcion,a.PrecioDeVenta, a.Costo, a.IDCategoria,b.Nombre as Categoria FROM productos a, categorias b WHERE a.IDCategoria=b.IDCategoria;");
            DataController.Operacion oOperacion = new DataController.Operacion();
            Resultado = oOperacion.Consultar(Consulta.ToString());
            return Resultado;
        }
        ...
        public static DataTable TODOS_LAS_FACTURAS()
        {
            DataTable Resultado = new DataTable();
            StringBuilder Consulta = new StringBuilder();
            Consulta.Append(@"SELECT a.IDFacturaDeVenta, a.Fecha, a.FormaDePago, a.IDCliente, c.Nombres, a.IDEmpleado, d.Nombres,
                a.Excento, a.Gravado, a.NoSujeto, a.MontoDeIVA, a.SubTotal, a.TotalAPagar, 
                b.IDDetalleFactura, b.Cantidad, b.Precio, b.NombreProducto, b.IDProducto, b.IDFacturaDeVenta, b.Descripcion
